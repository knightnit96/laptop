...
<head>
  ...
  <title>Detail-Order | KnightSHOP</title>
				  ...
				  <section class="invoice">
				    ...
				    <div class="row no-print">
				        <div class="col-xs-12">
				          ...
				          <a type="button" class="btn btn-primary pull-right" style="margin-right: 5px;" href="${pageContext.request.contextPath }/order/detail/${objItem.id_order }/print">
