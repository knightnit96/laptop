    ...
    <section class="content-header">
      ...
      <a href="${pageContext.request.contextPath }/admincp/video"><button type="button" class="btn btn-default"><i class="fa fa-arrow-left"></i> Back to Video Management</button></a>
       ...
       <div class="box-body">
            ...
            <!-- form start -->
            <form id="editVideo" action="${pageContext.request.contextPath }/admincp/video/edit/${objItem.id}" method="post" enctype="multipart/form-data">
              <div class="box-body">
              	
              	<div class="form-group col-sm-8">
	              <label class="control-label" for="name">Video name</label>
	              <div class="col-xl-6">
	             	<input type="text" class="form-control" id="name" name="name" placeholder="Enter video name" value="${objItem.name}">
	              </div>
	            </div>
