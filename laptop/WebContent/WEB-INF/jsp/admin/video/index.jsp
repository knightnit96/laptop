...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-youtube-play"></i> &nbsp;&nbsp;Video Management</li>
      </ol>
    </section>
    <section class="content-header">
      ...
      <a href="${pageContext.request.contextPath }/admincp/video/add"><button type="button" class="btn btn-default"><i class="fa fa-plus"></i> Add new video</button></a>
      </div>	
       <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <c:set var="urlEdit" value="${pageContext.request.contextPath }/admincp/video/edit/${objItem.id }"></c:set>
                <c:set var="urlDel" value="${pageContext.request.contextPath }/admincp/video/del/${objItem.id }"></c:set>
                <tr>
                  <td>${objItem.id}</td>
                  <td>${objItem.name}</td>
                  <td>${objItem.link}</td>
