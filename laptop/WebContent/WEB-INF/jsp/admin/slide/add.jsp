    ...
    <section class="content-header">
      ...
      <a href="${pageContext.request.contextPath }/admincp/slide"><button type="button" class="btn btn-default"><i class="fa fa-arrow-left"></i> Back to Slide Management</button></a>
       ...
       <div class="box-body">
            ...
            <!-- form start -->
            <form id="addSlide" action="${pageContext.request.contextPath }/admincp/slide/add" method="post" enctype="multipart/form-data">
              <div class="box-body">
              	
              	<div class="form-group col-sm-6">
	              <label class="control-label" for="name">Name</label>
	              <div class="col-xl-6">
	             	<input type="text" class="form-control" id="name" name="name" placeholder="Enter slide name">
	              </div>
	            </div>
                
                <div class="form-group col-sm-6">
                  <label class="control-label" for="id_laptop">Mã laptop</label>
                  <div class="col-xl-6">
                  	<input type="text" class="form-control" id="id_laptop" name="id_laptop" placeholder="Enter id laptop">
               	  </div>
                </div>
