    ...
    <section class="content-header">
      ...
      <a href="${pageContext.request.contextPath }/admincp/payment"><button type="button" class="btn btn-default"><i class="fa fa-arrow-left"></i> Back to Payment Management</button></a>
       ...
       <div class="box-body">
            ...
            <!-- form start -->
            <form id="addPayment" action="${pageContext.request.contextPath }/admincp/payment/edit/${objItem.id_payment}" method="post" >
              <div class="box-body">
              	
              	<div class="form-group">
	              <label class="control-label" for="name">Payment Name</label>
	              <div class="col-xl-12">
	             	<input type="text" class="form-control" id="name" name="name" placeholder="Enter payment name" value="${objItem.name}">
	              </div>
	            </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-xl-12">
                  	<textarea rows="3" name="info" id="info" class="form-control" placeholder="Enter payment info">${objItem.info}</textarea>
               	  </div>
                </div>
              </div>
              <!-- /.box-body -->
